...
namespace Moe.La.Core.Dtos
{
    public class MoeenCaseDto
    {
        ...
        public ICollection<MoeenHearingDto> Hearings { get; set; } = new List<MoeenHearingDto>();

        public ICollection<MoeenPartyDto> Parties { get; set; } = new List<MoeenPartyDto>();
