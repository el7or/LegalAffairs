...
@Component({
  selector: 'app-moamalat-outbound-list',
  templateUrl: './moamalat-outbound-list.component.html',
  styleUrls: ['./moamalat-outbound-list.component.css'],
  animations: [
...
export class MoamalatOutboundListComponent implements OnInit, AfterViewInit, OnDestroy {
  columnsToDisplay = [
    'position',
    'subject',
    'referenceNo',
  ...
  populateMoamalatTransactions() {
    ...
    this.queryObject.transactionType = MoamalaTransactionTypes.outbound;
    this.subs.add(
